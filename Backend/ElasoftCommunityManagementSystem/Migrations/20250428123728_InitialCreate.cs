        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastTwoFactorSetup = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityId = table.Column<int>(type: "int", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Announcement_Club_ClubId",
                        column: x => x.ClubId,
                        principalTable: "Club",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BudgetRequestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClubId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BudgetRequest", x => x.BudgetRequestId);
                    table.ForeignKey(
                        name: "FK_BudgetRequest_Club_ClubId",
                        column: x => x.ClubId,
                        principalTable: "Club",
                        principalColumn: "ClubId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BudgetRequest_Users_ApproverUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InKindSupport = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubExpenses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClubExpenses_Club_ClubId",
                        column: x => x.ClubId,
                        principalTable: "Club",
                        principalColumn: "ClubId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClubMembership", x => x.MembershipId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClubMembership_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcement_ClubId",
                table: "Announcement",
                column: "ClubId");

            migrationBuilder.CreateIndex(
                name: "IX_BudgetRequest_ApproverUserId",
                table: "BudgetRequest",
                column: "ApproverUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BudgetRequest_ClubId",
                table: "BudgetRequest",
                column: "ClubId");

            migrationBuilder.CreateIndex(
                name: "IX_Club_AdvisorId",
                table: "Club",
                column: "AdvisorId");
